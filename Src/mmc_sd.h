...
#define MMC_SD_SPI1_PORT		GPIOA

#define MMC_SD_SCK_PORT			MMC_SD_SPI1_PORT
#define MMC_SD_SCK_PIN			GPIO_PIN_5

#define MMC_SD_MISO_PORT		MMC_SD_SPI1_PORT
#define MMC_SD_MISO_PIN			GPIO_PIN_6

#define MMC_SD_MOSI_PORT		MMC_SD_SPI1_PORT
#define MMC_SD_MOSI_PIN			GPIO_PIN_7


#define MMC_SD_CS_PORT			GPIOA
#define MMC_SD_CS_PIN			GPIO_PIN_4
...
#define MSD_CS_ENABLE()     HAL_GPIO_WritePin(MMC_SD_CS_PORT, MMC_SD_CS_PIN, GPIO_PIN_RESET)

/* Deselect MSD Card: ChipSelect pin high */  
#define MSD_CS_DISABLE()    HAL_GPIO_WritePin(MMC_SD_CS_PORT, MMC_SD_CS_PIN, GPIO_PIN_SET)
